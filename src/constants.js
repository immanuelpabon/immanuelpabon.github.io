...
export const dialogueData = {
  ...
  tv: [
    ...
    "Dude, seriously. I have no more dialouge, this all I have to say.",
    "Okay I lied, but there's a lot of more interesting stuff in any direction besides here.",
    "...",
    ".........",
    "......................",
    "You're still here.",
    ...
    "...",
    "Well, its nice to have someone around to talk to, I guess. You're what, a goat?",
    ...
    "I am going to pretend this conversation never happend."
  ],
