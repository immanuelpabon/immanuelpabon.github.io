...
var EventController = class _EventController {
  ...
  static join(events) {
    const ev = new _EventController(() => events.forEach((e) => e.cancel()));
...
var Asset = class _Asset {
  ...
  data = null;
  error = null;
  onLoadEvents = new Event();
  onErrorEvents = new Event();
  onFinishEvents = new Event();
  constructor(loader) {
    loader.then((data) => {
      this.loaded = true;
      this.data = data;
...
function sprite(src, opt = {}) {
  ...
  let curAnim = null;
  let curAnimDir = null;
  const spriteLoadedEvent = new Event();
  if (!src) {
    throw new Error(
