...
import type { AgentComp, AgentCompOpt, AnchorComp, AreaComp, AreaCompOpt, BodyComp, BodyCompOpt, CircleComp, ColorComp, DoubleJumpComp, FixedComp, FollowComp, HealthComp, LayerComp, LifespanCompOpt, MaskComp, NamedComp, OffScreenComp, OffScreenCompOpt, OpacityComp, OutlineComp, PolygonComp, PolygonCompOpt, PosComp, RectComp, RectCompOpt, RotateComp, ScaleComp, ShaderComp, SpriteComp, SpriteCompOpt, StateComp, StayComp, TextComp, TextCompOpt, TileComp, TileCompOpt, TimerComp, UVQuadComp, ZComp } from "./components/";
...
export type { AgentComp, AgentCompOpt, AnchorComp, AreaComp, AreaCompOpt, Asset, BodyComp, BodyCompOpt, CircleComp, ColorComp, DoubleJumpComp, Event, EventController, EventHandler, FixedComp, FollowComp, FontData, HealthComp, LayerComp, LifespanCompOpt, MaskComp, NamedComp, OffScreenComp, OffScreenCompOpt, OpacityComp, OutlineComp, PolygonComp, PolygonCompOpt, PosComp, RaycastHit, RaycastResult, RectComp, RectCompOpt, RotateComp, ScaleComp, ShaderComp, ShapeType, SpriteComp, SpriteCompOpt, StateComp, StayComp, TextComp, TextCompOpt, TileComp, TileCompOpt, TimerComp, UVQuadComp, Vec2, ZComp, };
...
export interface KaboomCtx<TButtonDef extends ButtonsDef = {}, TButton extends string = string> {
     ...
     * @group Input
     */
    onGamepadButtonDown(btn: GamepadButton | GamepadButton[], action: (btn: GamepadButton) => void): EventController;
    /**
     ...
     * @group Input
     */
    onGamepadButtonDown(action: (btn: GamepadButton) => void): EventController;
    /**
     ...
     * @group Input
     */
    onGamepadButtonPress(btn: GamepadButton | GamepadButton[], action: (btn: GamepadButton) => void): EventController;
    /**
     ...
     * @group Input
     */
    onGamepadButtonPress(action: (btn: GamepadButton) => void): EventController;
    /**
     ...
     * @group Input
     */
    onGamepadButtonRelease(btn: GamepadButton | GamepadButton[], action: (btn: GamepadButton) => void): EventController;
    /**
