...
export declare function testRectPoint2(r: Rect, pt: Point): boolean;
export declare function testRectPoint(r: Rect, pt: Point): boolean;
...
export declare function testCirclePoint(c: Circle, p: Point): boolean;
...
export declare function testPolygonPoint(poly: Polygon, pt: Point): boolean;
export declare function testEllipsePoint(ellipse: Ellipse, pt: Point): boolean;
...
export declare function testPointPoint(p1: Point, p2: Point): boolean;
/**
 * @group Math
 */
...
export declare function testLineShape(line: Line, shape: ShapeType): boolean;
export declare function testCircleShape(circle: Circle, shape: ShapeType): boolean;
export declare function testRectShape(rect: Rect, shape: ShapeType): boolean;
export declare function testPolygonShape(polygon: Polygon, shape: ShapeType): boolean;
